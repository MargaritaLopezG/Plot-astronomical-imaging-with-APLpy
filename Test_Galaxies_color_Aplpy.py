...
gc = aplpy.FITSFigure('A85/A85_galaxies/2MASX_J004136-085933_DesiLegacy-g2.fits',figure=fig)

# Produce a 'rgu color image' from three bands of astronomical images 
rgu = ['A85/A85_galaxies/2MASX_J004136-085933_DesiLegacy-z2.fits','A85/A85_galaxies/2MASX_J004136-085933_DesiLegacy-r2.fits', 'A85/A85_galaxies/2MASX_J004136-085933_DesiLegacy-g2.fits']
aplpy.make_rgb_image(rgu,'A85/A85_rgu/2MASX_J004136-085933_DesiLegacy_2_color.png', vmin_b=0., vmax_b=0.06, vmin_g=0., vmax_g=0.1, vmin_r=0., vmax_r=0.2)

# Show the previous 'rgu color image' created
gc.show_rgb('A85/A85_rgu/2MASX_J004136-085933_DesiLegacy_2_color.png')
...
gc.add_label(0.8, 0.95, '2MASX J00413620-0859339', relative=True, color='white', fontsize=14) 
